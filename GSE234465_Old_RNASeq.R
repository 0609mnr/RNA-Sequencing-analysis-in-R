...
# 
# In this document, I provide a step-by-step RNA-Seq analysis using R tools, focusing on the processing, analysis, 
# and visualization of the publicly available RNA-sequencing dataset from Parafati et al. 2023 (GSE234465). 
# Here, I will only perform the analysis comparing two study groups that I have selected. 
...
ggplot(resDE_Old, aes(x = log2FoldChange, 
                      y = -log10(padj), 
                      color = resDE_Old$Group)) + # assign axis and color genes based on "Group" column (significance)
...
# The variable has to contain the list of gene_ids that have been used in the differential gene expression.
